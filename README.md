...
| ------------------------ | --------------------------------------- | ---------------------------------------------------------------------- |
| `src` [Array or String ] | _True_ (if `srcObject` is not provided) | The source of the media                                                |
| `srcObject` [Object]     | _True_ (if `src` is not provided)       | The source of the media                                                |
| `kind` [String]          | _True_                                  | It's either `audio` or `video`.                                        |
| `muted` [String]         | _False_                                 | Determines if a video will be muted or not. It's either true or false. |
